...
const config = {
    A187: 'RAHMAD', // TOBAT SU ASU
    instagram: 'https://instagram.com/rahmad.80', // INFO JANGAN DI UBAH
    nomer: 'wa.me/62895636761912', // INFO SU JNGAN DI UBAH
    youtube: 'https://youtube.com/channel/UCnGKPo3UBoOT3izSUbBo4pQ', // KINTIL
...
𝚈𝚊𝚗𝚐 𝚗𝚐𝚐𝚊𝚔 𝚒𝚗𝚝𝚛𝚘 𝚊𝚗𝚊𝚔 𝚋𝚊𝚋𝚒:>`
				...
				teks = `𝗬𝗲𝗲 𝗯𝗲𝗯𝗮𝗻 𝗴𝗿𝘂𝗯 *${mdata.subject}* 𝘂𝗱𝗮𝗵 𝗸𝗲𝗹𝘂𝗮𝗿. @${num.split('@')[0]}\n 𝗝𝗮𝗻𝗴𝗮𝗻 𝗸𝗲𝘀𝗶𝗻𝗶 𝗹𝗮𝗴𝗶 𝘆𝗮 𝘁𝗼𝗱🏃`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
		...
		try {
           ...
           case 'demote':
				...
				case 'promote':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('𝐓𝐚𝐠 𝐭𝐚𝐫𝐠𝐞𝐭 𝐲𝐚𝐧𝐠 𝐦𝐚𝐮 𝐝𝐢 𝐣𝐚??𝐢𝐤𝐚𝐧 𝐚𝐝𝐦𝐢𝐧!')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
              ...
              case 'owner':
               ...
               client.sendMessage(from, '𝙽𝚒𝚑 𝚘𝚠𝚗𝚎𝚛 𝚔𝚞 𝚝𝚘𝚍, 𝚌𝚑𝚊𝚝 𝚊𝚓𝚊 𝚙𝚊𝚜𝚝𝚒 𝚍𝚒𝚛𝚎𝚜𝚙𝚘𝚗. 𝙹𝚊𝚗𝚐𝚊𝚗 𝚕𝚞𝚙𝚊 𝚍𝚒𝚜𝚊𝚟𝚎 𝚢𝚊 𝚝𝚘𝚍',MessageType.text, { quoted: mek} )
                break  
              ...
              case 'abgjago':
				...
				case 'url2img': 
					...
					if (args.length < 1) return reply('𝐏??𝐥𝐢𝐡 𝐭𝐢𝐩𝐞 𝐧𝐲𝐚 𝐤𝐚𝐤?')
				...
				case 'bc': 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `[ 𝗕𝗥𝗢𝗔𝗗𝗖𝗔𝗦𝗧 𝗥𝗔𝗛𝗠𝗔𝗗-𝗕𝗢𝗧 ]\n\n${body.slice(4)}`})
						}
						reply('𝐬𝐮𝐜𝐜𝐬𝐬 𝐛𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `[ 𝗕𝗥𝗢𝗔𝗗𝗖𝗔𝗦𝗧 𝗥𝗔𝗛𝗠𝗔𝗗-𝗕𝗢𝗧 ]\n\n${body.slice(4)}`)
						}
						reply('𝐬𝐮𝐜𝐜𝐬𝐬 𝐛𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭')
					}
					break
				...
				case 'welcome':
					...
					if (Number(args[0]) === 1) {
						...
						fs.writeFileSync('./src/welkom.json', JSON.stringify(welkom))
						reply('❬ 𝐒𝐔𝐂𝐂𝐒𝐄𝐒𝐒 ❭ 𝐦𝐞𝐧𝐨𝐧𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧 𝐟𝐢𝐭𝐮𝐫 ??𝐞𝐥𝐜𝐨𝐦𝐞 𝐩𝐚𝐝𝐚 𝐠𝐫𝐨𝐮𝐩 𝐢𝐧𝐢️')
					} else {
						reply('𝐤𝐞𝐭𝐢𝐤 𝟏 𝐮𝐧𝐭𝐮𝐤 𝐦𝐞𝐧𝐠𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧, 𝟎 𝐮𝐧𝐭𝐮𝐤 𝐦𝐞𝐧𝐨𝐧𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧 𝐟𝐢𝐭𝐮𝐫')
					}
				case 'clone':
